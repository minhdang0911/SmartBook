...
export default function AboutPage() {
  const faqItems = [
    ...
    },
    {
      ...
      children: <p>Bạn có thể tìm kiếm sách, thêm vào giỏ hàng và thanh toán trực tuyến hoặc nhận sách giấy tại nhà.</p>,
    },
    {
      key: '3',
      ...
      >
        ...
        >
          ...
          <div style={{ textAlign: 'left' }}>
            <span style={{ letterSpacing: 3, fontSize: '2.1rem', fontWeight: 'bold', lineHeight: 1 }}>SmartBook</span>
    ...
    SmartBook - Sách cho mọi nhà
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ background: '#e8f5e9', borderRadius: 8, padding: '10px 18px', color: '#27ae60', fontWeight: 600, fontSize: 15, minWidth: 160, boxShadow: '0 1px 4px #b2dfdb22' }}>
                  📚 Hơn 10.000+ đầu sách
                </div>
                <div style={{ background: '#e8f5e9', borderRadius: 8, padding: '10px 18px', color: '#27ae60', fontWeight: 600, fontSize: 15, minWidth: 160, boxShadow: '0 1px 4px #b2dfdb22' }}>
        ...
        <div style={{ flex: '2', minWidth: '320px', padding: '0 10px' }}>
          <h2 style={{ color: '#27ae60', marginBottom: '18px', fontSize: 28, fontWeight: 700 }}>Về SmartBook</h2>
          <p style={{ fontSize: 17, lineHeight: 1.7, marginBottom: 12 }}>
            <b>SmartBook</b> là nền tảng đọc sách hiện đại, kết nối cộng đồng yêu sách Việt Nam với kho sách đa dạng từ sách giấy, eBook đến AudioBook. Chúng tôi mang đến trải nghiệm đọc sách tiện lợi, cá nhân hóa và thân thiện trên mọi thiết bị.
          </p>
          <p style={{ fontSize: 17, lineHeight: 1.7, marginBottom: 12 }}>
            ...
            <ul style={{ margin: '8px 0 8px 24px', fontSize: 16, color: '#333' }}>
              ...
              <li>Trải nghiệm đọc sách không giới hạn trên mọi thiết bị: điện thoại, máy tính bảng, laptop.</li>
              <li>Hỗ trợ nhiều hình thức: sách giấy, eBook, AudioBook, đáp ứng mọi nhu cầu đọc của bạn.</li>
            </ul>
          </p>
          <p style={{ fontSize: 17, lineHeight: 1.7, marginBottom: 12 }}>
            Đội ngũ <b>SmartBook</b> luôn nỗ lực phát triển công nghệ, hợp tác với các nhà xuất bản uy tín để mang lại giá trị thực cho cộng đồng độc giả Việt. Chúng tôi tin rằng mỗi cuốn sách là một hành trình, và SmartBook sẽ đồng hành cùng bạn trên hành trình tri thức ấy.
          </p>

          {/* FAQ - Hỏi đáp */}
          <div style={{ marginTop: 40, marginBottom: 24 }}>
            <h3 style={{ color: '#27ae60', marginBottom: 16, fontSize: 22 }}>Câu hỏi thường gặp</h3>
            <Collapse items={faqItems} accordion style={{ background: '#f4fff7', borderRadius: 8, border: '1px solid #b2dfdb55' }} />
          </div>
